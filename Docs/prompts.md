# Dokumentasi Kumpulan Prompt

Berikut adalah daftar *prompt* atau instruksi utama yang digunakan secara bertahap selama proses pengembangan aplikasi perpustakaan berbasis *microservice*.
...
### Membuat Fitur Peminjaman dan Pengembalian
```
Buatkan service untuk mahasiswa meminjam dan mengembalikan buku.
```

### Membuat Aturan Peminjaman
```
...
### Menghubungkan Book Service dan Loan Service
```
