...
Frontend: Menangani antarmuka pengguna (UI).

Book Service (Port 3001): Mengelola entitas dan stok buku.

Loan Service (Port 3002): Mengelola transaksi peminjaman dan aturan batas maksimal kuota buku mahasiswa.
